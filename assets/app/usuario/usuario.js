$(document).ready(function () {
  ...
  usuariotabla = $('#usuariotabla').DataTable({
    ...
    pageLength: 10,
    ajax: {
      url: "assets/app/usuario/usuario_controller.php?op=vertodousuario",
      method: 'POST',
      dataSrc: ""
    },
    columns: [
  ...
  $.ajax({
    url: "assets/app/usuario/usuario_controller.php?op=verroles",
    method: "POST",
    dataType: "json",
  ...
  $.ajax({
    url: "assets/app/usuario/usuario_controller.php?op=verestatus",
    method: "POST",
    dataType: "json",
    success: function (data) {
  ...
  $.ajax({
    url: "assets/app/usuario/usuario_controller.php?op=veropbloquear",
    method: "POST",
    dataType: "json",
    success: function (data) {
  ...
  $('#formulariodeusuario').submit(function (e) {
    ...
    estatus = $('#estatus').val();
    $.ajax({
      url: "assets/app/usuario/usuario_controller.php?op=guargarusuario",
      type: "POST",
      dataType: "json",
      data: {
        id: id,
...
$(document).on("click", ".btneliminar", function () {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.ajax({
        url: "assets/app/usuario/usuario_controller.php?op=eliminarusuario",
        type: "POST",
        dataType: "json",
        data: { id: id },
        success: function (data) {
...
$(document).on("click", ".btneditar", function () {
  id = $('#idusuario').val();
  $.ajax({
    url: "assets/app/usuario/usuario_controller.php?op=verusuario",
    method: "POST",
    dataType: "json",
    data: { id: id },
    success: function (data) {
